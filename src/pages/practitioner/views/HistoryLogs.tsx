      ...
      <div className="bg-card border border-card-border rounded-[40px] p-8 lg:p-12 shadow-sm dark:shadow-none transition-colors">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 transition-colors">
           <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-black text-text-main uppercase tracking-tight leading-none italic transition-colors">Historical Audit Trail</h3>
                <p className="text-[10px] font-bold text-sidebar-text-muted uppercase tracking-widest mt-1 transition-colors">Full clinical telemetry history across all nodes</p>
              </div>
           </div>
