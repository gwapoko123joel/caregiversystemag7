...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-text-main overflow-hidden selection:bg-sky-500 selection:text-slate-50 transition-colors duration-300">
      {/* ── Background Glows ── */}
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#020617]/80 backdrop-blur-md border-b border-white/5 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-slate-50 uppercase tracking-tighter text-2xl">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/10 mr-4">
              ...
              <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-widest">Network Live</span>
            </div>
            
            <Link 
              to="/login"
              className="px-6 py-2.5 bg-sky-500 hover:bg-sky-400 !text-slate-950 font-semibold uppercase text-[10px] tracking-widest rounded-xl transition-all shadow-lg shadow-sky-500/20 active:scale-95 flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-10">
              ...
              <div className="inline-flex items-center gap-4 px-4 py-2 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                ...
                <span className="text-[10px] font-semibold text-slate-50 uppercase tracking-[0.4em]">Node Deployment: DUM-PH_X01</span>
              </div>

              {/* Professional Headline */}
              <div className="space-y-4">
                <h1 className="text-6xl md:text-[5.5rem] font-semibold text-slate-50 leading-[0.85] tracking-tighter uppercase italic leading-tight">
                  Field-To-Clinic <br/>
              ...
              <p className="text-slate-400 text-lg md:text-xl font-medium leading-relaxed max-w-xl">
                A synchronized health coordination network for <span className="text-slate-50 font-bold">Barangay Bantayan</span>. 
              ...
              <div className="flex flex-wrap items-center gap-6 pt-6">
                <Link 
                  to="/login" 
                  className="px-10 py-5 bg-sky-500 hover:bg-sky-400 !text-slate-950 rounded-2xl font-semibold uppercase text-xs tracking-[0.3em] transition-all shadow-2xl shadow-sky-500/30 active:scale-95 flex items-center gap-3"
                >
            ...
            <div className="lg:col-span-6 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[550px] aspect-square">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-sky-500/5 rounded-[4rem] border border-sky-500/10 backdrop-blur-3xl flex items-center justify-center z-20 shadow-2xl">
                   ...
                   <p className="absolute bottom-6 text-[9px] font-semibold text-sky-500/60 uppercase tracking-[0.3em] leading-relaxed">Central Hub</p>
                </div>
                ...
                <div className="absolute top-[5%] left-[5%] p-5 bg-slate-900/80 border border-emerald-500/30 rounded-3xl backdrop-blur-xl shadow-2xl animate-float z-30">
                   <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[9px] font-semibold text-slate-400 uppercase">Node_BHW_01</span>
                   </div>
                   <p className="text-lg font-mono text-slate-50 font-bold leading-relaxed">BP: 120/80</p>
                   <p className="text-[8px] font-bold text-emerald-500 uppercase mt-1 leading-relaxed">Status: Normal</p>
                </div>
                ...
                <div className="absolute bottom-[10%] right-[5%] p-5 bg-slate-900/80 border border-rose-500/30 rounded-3xl backdrop-blur-xl shadow-2xl animate-float z-30" style={{ animationDelay: '1.5s' }}>
                   <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[9px] font-semibold text-slate-400 uppercase">Node_BHW_04</span>
                   </div>
                   <p className="text-lg font-mono text-rose-400 font-bold leading-relaxed">O2: 89%</p>
                   <p className="text-[8px] font-bold text-rose-500 uppercase mt-1 leading-relaxed">Alert: Critical</p>
                </div>
      ...
      <footer className="bg-[#020617] border-t border-white/5 py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-sky-500 rounded-lg flex items-center justify-center">
                <Heart size={18} fill="white" className="text-slate-50" />
              </div>
              <span className="font-semibold text-slate-50 uppercase tracking-tighter text-xl">
                Bantayan<span className="text-sky-500">Care</span>
              </span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/5 border border-emerald-500/20 rounded-full">
               ...
               <span className="text-[8px] font-semibold text-emerald-500 uppercase tracking-widest">HIPAA Compliant System</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-4">
              <h4 className="text-[10px] font-semibold text-slate-50 uppercase tracking-[0.2em]">Resources</h4>
            ...
            <div className="space-y-4">
              <h4 className="text-[10px] font-semibold text-slate-50 uppercase tracking-[0.2em]">Deployment</h4>
              <p className="text-slate-500 text-[10px] uppercase font-bold leading-relaxed">Dumaguete City<br/>Negros Oriental</p>
            </div>
          </div>
          ...
          <div className="bg-white/5 p-6 rounded-[32px] border border-white/5 space-y-4">
            <div className="flex items-center justify-between">
               <span className="text-[9px] font-semibold text-slate-500 uppercase tracking-widest">System Status</span>
               <div className="flex items-center gap-1.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-[9px] font-semibold text-emerald-500 uppercase">Operational</span>
               </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[9px] font-semibold text-slate-600 uppercase tracking-widest leading-relaxed">
          ...
          <div className="flex items-center gap-4 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all">
             <Globe size={18} className="text-slate-50 cursor-pointer hover:text-sky-500" />
             <Mail size={18} className="text-slate-50 cursor-pointer hover:text-sky-500" />
             <Navigation size={18} className="text-slate-50 cursor-pointer hover:text-sky-500" />
          </div>
        </div>
      </footer>
    </div>
...
function FeatureInfo({ title, desc }: { title: string, desc: string }) {
  return (
    <div className="p-8 bg-white/5 border border-white/5 rounded-[32px] hover:border-sky-500/20 transition-all group">
      <h4 className="text-slate-50 font-semibold uppercase text-xs tracking-widest mb-3 group-hover:text-sky-500 transition-colors">{title}</h4>
