    ...
    <div className="space-y-8 animate-in fade-in duration-500 slide-in-from-bottom-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="p-6 bg-card border border-card-border rounded-3xl shadow-sm dark:shadow-none transition-colors">
           ...
           <div className="text-[10px] font-black text-sidebar-text-muted uppercase tracking-widest mb-1 transition-colors">Active Nodes</div>
           <div className="text-3xl font-black tracking-tight text-text-main transition-colors">{authStats.authorized}</div>
        </div>
        <div className="p-6 bg-card border border-card-border rounded-3xl shadow-sm dark:shadow-none transition-colors">
           <div className="flex items-center gap-4 mb-4">
           ...
           <div className="text-[10px] font-black text-sidebar-text-muted uppercase tracking-widest mb-1 transition-colors">Pending Approval</div>
           <div className="text-3xl font-black tracking-tight text-text-main transition-colors">{authStats.pending}</div>
        </div>
        <div className="p-6 bg-card border border-card-border rounded-3xl shadow-sm dark:shadow-none transition-colors">
           <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-sky-500/10 text-sky-500 rounded-2xl flex items-center justify-center">
           ...
           <div className="text-[10px] font-black text-sidebar-text-muted uppercase tracking-widest mb-1 transition-colors">Revoked Access</div>
           <div className="text-3xl font-black tracking-tight text-text-main transition-colors">{authStats.revoked}</div>
        </div>
        <div className="p-6 bg-card border border-card-border rounded-3xl shadow-sm dark:shadow-none transition-colors">
           <div className="flex items-center gap-4 mb-4">
           ...
           <div className="text-[10px] font-black text-sidebar-text-muted uppercase tracking-widest mb-1 transition-colors">Security Events</div>
           <div className="text-3xl font-black tracking-tight text-text-main transition-colors">{securityEvents.length}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-card border border-card-border rounded-[32px] p-8 shadow-sm dark:shadow-none transition-colors">
           <h3 className="text-xl font-black text-text-main uppercase tracking-tight mb-6 transition-colors">Policy Enforcement</h3>
           <div className="space-y-4">
              <div className="p-4 bg-sky-500/5 border border-sky-500/20 rounded-2xl flex items-center justify-between shadow-sm dark:shadow-none">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       <div className="text-sm font-black text-text-main uppercase transition-colors">Row Level Security (RLS)</div>
                 ...
                 <span className="text-[10px] font-black text-sky-500 bg-sky-500/10 px-2 py-1 rounded uppercase">Active</span>
              </div>
              <div className="p-4 bg-sky-500/5 border border-sky-500/20 rounded-2xl flex items-center justify-between shadow-sm dark:shadow-none">
                 <div className="flex items-center gap-3">
                    <Lock size={20} className="text-sky-500" />
                    <div>
                       <div className="text-sm font-black text-text-main uppercase transition-colors">Strict Auth Hooks</div>
                 ...
                 <span className="text-[10px] font-black text-sky-500 bg-sky-500/10 px-2 py-1 rounded uppercase">Enforced</span>
              </div>
              <div className="p-4 bg-card border border-card-border rounded-2xl flex items-center justify-between opacity-70 transition-colors shadow-sm dark:shadow-none">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       <div className="text-sm font-black text-text-main uppercase transition-colors">2FA Requirement</div>
                 ...
                 <span className="text-[10px] font-black text-sidebar-text-muted bg-slate-100 dark:bg-white/10 px-2 py-1 rounded uppercase transition-colors">Not Configured</span>
              </div>
           </div>
        </div>
        ...
        <div className="bg-card border border-card-border rounded-[32px] p-8 shadow-sm dark:shadow-none transition-colors">
           <h3 className="text-xl font-black text-text-main uppercase tracking-tight mb-6 transition-colors">Recent Security Actions</h3>
           <div className="space-y-4">
              {securityEvents.slice(0, 5).map(event => (
                 <div key={event.log_id} className="flex gap-4 items-start p-4 bg-card rounded-2xl border border-card-border transition-colors shadow-sm dark:shadow-none">
                    ...
                    <div>
                       <div className="text-xs font-black text-text-main uppercase transition-colors">{event.action.replace(/_/g, ' ')}</div>
              ...
              {securityEvents.length === 0 && (
                 <div className="text-center py-8 text-[10px] font-black text-sidebar-text-muted uppercase tracking-widest transition-colors">No recent security events</div>
              )}
           </div>
        </div>
      </div>
